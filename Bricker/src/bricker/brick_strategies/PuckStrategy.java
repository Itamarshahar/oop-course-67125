...
public class PuckStrategy implements CollisionStrategy {
     ...
     *
     * @param baseStrategy     The base CollisionStrategy instance to be
     *                         wrapped by this strategy.
     ...
     * It calls the base collision strategy and then creates two new
     * pucks at the collision position.
     *
