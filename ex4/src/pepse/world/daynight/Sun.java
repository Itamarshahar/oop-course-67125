...
public class Sun {
    ...
    /**
     * Size factor relative to the window height
     */
    ...
    public static GameObject create(Vector2 windowDimensions, float cycleLength) {
        Vector2 sunSize = new Vector2(windowDimensions.y() * SUN_SIZE_FACTOR,
                windowDimensions.y() * SUN_SIZE_FACTOR);
        Vector2 initialSunCenter = Vector2.of(windowDimensions.x() * 0.5f,
                windowDimensions.y() - (Terrain.RATIO * windowDimensions.y() * Y_POS_INIT));
        Vector2 cycleCenter = Vector2.of(windowDimensions.x() * 0.5f, Terrain.RATIO * windowDimensions.y());
